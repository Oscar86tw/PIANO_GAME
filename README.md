...
修正 V6.4 功能已存在但入口不明顯的問題：
- 首頁新增「📷 手機拍照樂譜管理器」大卡片。
- 所有頁面的上方導覽列新增「📷 拍照樂譜」。
- 手機首頁右下新增固定拍照按鈕。
- import.html 標題正式更名為「手機拍照樂譜管理器」。
- 所有頁面可見版本同步為 V6.4.2。


## V6.4.2 拍照樂譜編輯與刪除
- 每筆拍照樂譜新增「編輯」按鈕。
- 可修改曲名、作者/來源、分類、BPM、拍號、小節數。
- 可補拍新頁、從相簿補頁、刪除單頁、前後移動頁面。
- 整首刪除會同步刪除 IndexedDB 圖片。
- 如果刪除到最後一頁，該樂譜紀錄也會一併移除。
